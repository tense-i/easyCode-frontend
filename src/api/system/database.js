...
// 查询动态数据源数据
export function databaseInfo(data, query) {
    return request({
        url: '/dbdog/dynamicData/databaseInfo',
        method: 'post',
        params: query,
        data: data
    })
...
// 查询动态数据源数据
export function listDynamicDatabaseData(data, query) {
    return request({
        url: '/dbdog/dynamicData/list/dynamicDatabaseData',
        method: 'post',
        params: query,
        data: data
    })
...
// 查询字段数据
export function listDynamicColumn(data, query) {
    return request({
...
// 修改生成模板信息
export function updateOrSaveVms(data) {
    return request({
