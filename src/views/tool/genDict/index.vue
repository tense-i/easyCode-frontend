<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item>
        <el-button type="primary" icon="Search" @click="doListGenDictByPage"
          >搜索</el-button
        >
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="info" plain icon="Upload" @click="openImport"
          >导入
        </el-button>
      </el-col>
    ...
    <el-dialog v-model="dialogGenDict" title="编辑词库" width="500" draggable>
      ...
      >
        ...
        >
          <el-input
            v-model="data.p.genDict.content"
            type="textarea"
