    ...
    <el-dialog title="导入表" v-model="visible" width="800px" top="5vh" append-to-body>
        <el-tabs type="border-card">
            <el-tab-pane label="导入建表语句">
                ...
                <el-row class="mb-4">
                    <el-button type="primary" @click="handleGetGenTableBySql">导入</el-button>
...
<!--                        <el-button icon="Refresh" @click="resetQuery">重置</el-button>-->
                        <el-button type="primary" @click="handleImportTable">导入</el-button>
                    </el-form-item>
                </el-form>
                <el-row>
                    <el-table @row-click="clickRow" ref="table" :data="dbTableList"
...
<script setup>
import {generateBySchemaV2, getGenTableBySql, getSchemaBySql, listDbTable} from "@/api/tool/gen";
