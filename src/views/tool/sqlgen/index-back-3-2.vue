  ...
  <div class="app-container">
    ...
    <table-table :columns="tableSchemaList" v-if="false">
      ...
      <template v-slot:footer>
        ...
        <div>
          <el-col class="my-4">
            <el-button round @click="openImportTable" class="centered-90">
              导入表
            </el-button>
          </el-col>
          <el-col class="my-4">
      ...
      <el-collapse v-for="(p, index) in tableSchemaList" :key="index">
        <el-collapse-item :name="index">
          ...
          <div class="centered-90">
            <el-divider> ({{ p.tableName }})表字段配置 </el-divider>
            ...
            <div class="centered-90">
              <el-col class="my-4">
                <el-button
                  round
                  @click="handleAddField(p, fieldNew)"
                  class="centered-90"
                  >新增字段
                </el-button>
              </el-col>
