    ...
    <div class="app-container">
        ...
        <el-row :gutter="10">
            ...
            <el-col span="12">
                ...
                <el-button @click="doPreviewCodeByGenConfigAndGenTables">预览代码</el-button>
                            ...
                            <el-tabs v-model="generateSQL.tabName2" type="border-card">
                                ...
                                >
                                    ...
                                    <el-link :underline="false" icon="DocumentCopy"
                                             v-copyText="generateSQL.data[generateSQL.tabName1][generateSQL.tabName2]"
                                             v-copyText:callback="copyTextSuccess" style="float:right">&nbsp;复制
                                    </el-link>
                                    <div height="400px">
                                        <el-scrollbar>
                                            <pre>{{
                                                generateSQL.data[generateSQL.tabName1][generateSQL.tabName2]
                                                }}</pre>
                                        </el-scrollbar>
                                    </div>
                                </el-tab-pane>
...
import {
    ...
    synchDb,
    generateBySchemaV2,
    generateBySchemaV3, pageGenConfig
} from "@/api/tool/gen";
...
const {
    ...
    p,
    pageGenTableData,
    pageGenTableColumnData, generateSQL, queryGenConfigParams, genConfigs
} = toRefs(data);
