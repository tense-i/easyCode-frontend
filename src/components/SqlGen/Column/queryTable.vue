<template>
  ...
  <!--头部卡槽-->
    ...
    <column-table ref="columnTableRef" :columns="columnsData" :show-columns="showColumns" :selection="true">
        ...
        "
                ...
                <el-form-item>
                    ...
                    <el-button v-if="selection && handleOfSelectionName!=''" @click="handleOfSelectionEmits">
...
import {listTableInfo, pageGenTableColumn} from "@/api/system/genTableColumn.js";
