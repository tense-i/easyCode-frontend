    ...
    <el-drawer v-if="witch === 'drawer'"
        ...
        <el-tabs type="border-card">
            ...
            <el-tab-pane v-if="0!==(showTab&2)" label="生成表-字段">
                ...
                <el-form :model="queryGenTableColumnParams" ref="queryGenTableRef" :inline="true">
                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="10">
                            <el-form-item>
                                <el-button type="primary" icon="Search" @click="doPageGenTableColumn">搜索</el-button>
                                <el-button type="primary" @click="importGenTableColumnEmit">导入</el-button>
                            </el-form-item>
                        </el-col>
                    </el-row>
            ...
            <el-tab-pane v-if="0!==(showTab&4)" label="数据源">
                <el-space :size="10" spacer="">
                    ...
                    <el-button type="primary"
                               @click="importDynamicColumnEmits">导入
                    </el-button>
                ...
                <trends-table ref="importDynamicColumn"
                              :max-height="300"
...
import {dynamicTableConvertGenTable, listGenTable} from "@/api/system/genTable.js";
import {listDynamicColumn, listTableInfo, pageGenTable, pageGenTableColumn} from "@/api/system/genTableColumn.js";
...
watch(() => showTab, (newValue) => {
    emit('update:showTab', newValue);
});

// 导入genTables事件 返回genTables
// 导入sql事件 返回genTable
let $emit = defineEmits(['importSql', 'importDynamicColumn', 'importGenTableColumn']);
...
function changeListDynamicColumn() {
    ...
    for (let i = 0; i < tableNames.length; i++) {
        listDynamicColumn(dataSourceModel, {tableName: tableNames[i]}).then(res => {
            if (res.code === 200) {
